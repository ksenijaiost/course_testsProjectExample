...
/**
 * Класс DebitCard реализует интерфейс iCard и представляет собой дебетовую карту, которую можно использовать для снятия и пополнения денежных средств,
 * перевода средств между картами, добавления процентной суммы и просмотра истории транзакций. У него есть идентификатор карты, дата создания, текущая дата,
...
public class DebitCard implements ICard {
     ...
     * @throws DebitCardException Если пользователь не идентифицирован и сумма вывода превышает лимит ненадежного пользователя
     */
     ...
     *                            - Пользователь не идентифицирован, и сумма вывода превышает лимит ненадежного пользователя (если он не равен 0)
     ...
     * @throws DebitCardException если сумма перевода отрицательная, текущий баланс недостаточен или лимит превышен для неидентифицированного пользователя
     */
